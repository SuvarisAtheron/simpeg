document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fungsi untuk memuat dan menampilkan riwayat pensiun
    ...
    pensiunModalElement.addEventListener('shown.bs.modal', function () { /* ... kode sama ... */ });
    
    // 2. Logika pencarian pegawai
    namaInput.addEventListener('input', function() { /* ... kode sama ... */ });
    searchResultsContainer.addEventListener('click', function(e) { /* ... kode sama ... */ });
    ...
    // 4. Submit form pengajuan pensiun
    ...
    // 5. Hapus pengajuan pensiun dari tabel riwayat
    ...
    // (Kode event listener untuk search dan select pegawai disalin kembali untuk kelengkapan)
